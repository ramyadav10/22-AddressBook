...
public class AddressBook5 {
    ...
    public AddressBook5(String FirstName, String LastName, String Address, String City, int Zip,
    ...
    private static void getContact(AddressBook5 details) {
    ...
    public static boolean makechoice(AddressBook5 contact1, HashMap contact) {
        Scanner obj = new Scanner(System.in);
    ...
    public static void main(String[] args) {
    	AddressBook5 details = new AddressBook5();
